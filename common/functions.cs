...
namespace DD.Functions
{
    ...
    {
        /// <summary>
        /// Kiểm tra xem người dùng đăng nhập vào có phải là Admin không
        /// </summary>
        /// <param name="username">Tên đăng nhập</param>
        /// <returns>Người dùng là Admin</returns>
        public static string? Username { get; set; }

        public static bool IsUserAdmin(string username)
        {
            using var db = new QLQuanNetContext();
            var user = db.Users.FirstOrDefault(u => u.Username == username && u.Role == "Admin");

            // Nếu khác null, tức là người dùng có quyền Admin
            return user != null;
        }
        public static bool AddUser(TextBox txtUsername, PasswordBox txtPassword, ComboBox cbxRole, CheckBox chkActive,
            TextBox txtFullname, DatePicker dpBirthdate, ComboBox cbxGender, TextBox txtEmail, TextBox txtPhone,
    ...
    {
        // Hàm xác thực người dùng
        public static bool AuthenticateUser(string username, string password, params string[] roles)
        {
            using (var db = new QLQuanNetContext())
            {
